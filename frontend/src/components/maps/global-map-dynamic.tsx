...
const GlobalMap = dynamic(
  () => import("@/components/maps/global-map").then((mod) => mod.GlobalMap),
  {
    ssr: false,
    loading: () => (
      <div className="h-full bg-cyber-surface rounded border border-cyber-border flex items-center justify-center">
